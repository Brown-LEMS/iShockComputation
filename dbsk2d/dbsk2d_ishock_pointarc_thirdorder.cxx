...
//: Constructor
dbsk2d_ishock_pointarc_thirdorder::dbsk2d_ishock_pointarc_thirdorder(
...
double dbsk2d_ishock_pointarc_thirdorder::EtaToTau(double eta, DIRECTION dir,
                                                   bool constrained) {
    if (dir == LEFT)
...
double dbsk2d_ishock_pointarc_thirdorder::LEtaToLTau(double eta,
                                                     bool constrained) {
...
double dbsk2d_ishock_pointarc_thirdorder::REtaToRTau(double eta,
                                                     bool constrained) {
    // locate extrinsic vector first
    VECTOR_TYPE rvec;
    if (_nu > 0) // point on the left
        ...
        rvec = this->rBPoint()->eta_to_vec(eta); // locate extrinsic vector
                                                 // first
...
vgl_point_2d<double>
dbsk2d_ishock_pointarc_thirdorder::getPtFromLTau(double ltau) {
    double R = (_Rl + _Rr) / 2;
...
vgl_point_2d<double>
dbsk2d_ishock_pointarc_thirdorder::getLFootPt(double ltau) {
...
vgl_point_2d<double>
dbsk2d_ishock_pointarc_thirdorder::getRFootPt(double rtau) {
