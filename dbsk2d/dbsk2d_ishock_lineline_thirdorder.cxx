...
dbsk2d_ishock_lineline_thirdorder::dbsk2d_ishock_lineline_thirdorder(
    ...
    _origin =
        _Al - 0.5 * _H * vgl_vector_2d<double>(vcl_cos(_ul), vcl_sin(_ul));
...
double dbsk2d_ishock_lineline_thirdorder::EtaToTau(double eta, DIRECTION dir,
                                                   bool constrained) {
...
double dbsk2d_ishock_lineline_thirdorder::r(double tau) { return _H / 2; }

double dbsk2d_ishock_lineline_thirdorder::rp(double tau) { return 0; }

double dbsk2d_ishock_lineline_thirdorder::rpp(double tau) { return 0; }

double dbsk2d_ishock_lineline_thirdorder::g(double tau) { return 0; }
...
double dbsk2d_ishock_lineline_thirdorder::k(double tau) { return 0; }

double dbsk2d_ishock_lineline_thirdorder::v(double tau) { return 100000; }

double dbsk2d_ishock_lineline_thirdorder::a(double tau) { return 0; }

double dbsk2d_ishock_lineline_thirdorder::phi(double tau) { return 0; }

vgl_point_2d<double>
dbsk2d_ishock_lineline_thirdorder::getPtFromLTau(double ltau) {
